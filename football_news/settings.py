...
SECRET_KEY = 'django-insecure-kod@54+&2uybfyp#bq6lx0omdlf56g(^ro)@my0o@-fn7*g$c$'

# SECURITY WARNING: don't run with debug turned on in production!
PRODUCTION = os.getenv('PRODUCTION', 'False').lower() == 'true'
DEBUG = True

ALLOWED_HOSTS = ["localhost", "127.0.0.1", "flora-cahaya-footballnews.pbp.cs.ui.ac.id", "10.0.2.2"]
